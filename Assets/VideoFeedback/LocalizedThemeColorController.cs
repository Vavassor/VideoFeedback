...
namespace VRCAudioLink
{
    ...
    public class LocalizedThemeColorController : UdonSharpBehaviour
#else
...
#endif
    {
        ...
        public Dropdown[] localizedDropdowns;
        ...
        {
            foreach (var dropdown in localizedDropdowns)
            {
                if (dropdown.gameObject.activeInHierarchy)
                {
                    dropdown.value = themeColorDropdown.value;
                    themeColorDropdown = dropdown;
                    break;
                }
            }
        }
